    ...
    <>
      ...
      {loading ? (
        ...
        <div className="bg-[url('https://images5.alphacoders.com/808/thumb-1920-808254.jpg')] text-shadow-[0_0_20px_rgba(255,255,255,0.6)] bg-cover bg-center bg-black/50 bg-blend-multiply h-screen flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="text-white text-lg md:text-xl mb-2 drop-shadow-[0_0_20px_rgba(255,255,255,0.6)]">
            Library books are a valuable resource that provide knowledge, stories, and research material to readers of all ages.
          </p>
          <p className="text-white text-lg md:text-xl mb-6 drop-shadow-[0_0_20px_rgba(255,255,255,0.6)]">
            They cover a wide range of subjects, from academics to entertainment, and can be borrowed, studied, or referenced by library members.
          </p>
          <button
        ...
        <div className="relative bg-[url('https://images5.alphacoders.com/808/thumb-1920-808254.jpg')] bg-cover bg-center bg-black/50 bg-blend-multiply h-screen flex items-center justify-center px-4">
          <div className="bg-white/20 backdrop-blur-md w-full max-w-md p-8 rounded-xl text-shadow-[0_0_20px_rgba(255,255,255,0.6)] shadow-lg border border-white/30 ring-2 ring-white/20 hover:ring-white/40 transition duration-300">
            <h2 className="text-center text-4xl font-bold text-white mb-6 drop-shadow-[0_0_20px_rgba(255,255,255,0.6)]">
            ...
            <input
              ...
              className="w-full py-2 px-4 mb-4 rounded-md focus:outline-none focus:ring-2 focus:ring-white/60 focus:ring-offset-1 bg-white/30 text-black border border-white/20 transition duration-300"
            />
            ...
            <input
              ...
              className="w-full py-2 px-4 mb-6 rounded-md focus:outline-none focus:ring-2 focus:ring-white/60 focus:ring-offset-1 bg-white/30 text-black border border-white/20 transition duration-300"
            />

            {/* Action Button */}
            <button className="w-full bg-white text-black py-2 rounded-full cursor-pointer font-bold shadow-[0_0_20px_rgba(255,255,255,0.6)] hover:shadow-[0_0_30px_rgba(255,255,255,0.9)] hover:scale-105 transition transform duration-300 mb-4">
              {isSignup ? "Sign Up" : "Login"}
            </button>
